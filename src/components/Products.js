		...
		<Container className="pt-5 pb-5">
			...
			<Row className="align-items-center text-center">
				<Carousel className="pt-5">
					<Carousel.Item>
						<img className="d-block w-100" src={converse} alt="First slide" />
					...
					<Carousel.Item>
						<img className="d-block w-100" src={wedges} alt="Second slide" />
					...
					<Carousel.Item>
						<img className="d-block w-100" src={heelsJeans} alt="Third slide" />
