        ...
        <header>
          ...
          <div className="container h-100">
            <div className="d-flex h-100 text-center align-items-center App-header">
                <img src={logo} className="App-logo" alt="logo" style={{boxShadow: '0 10px 20px -8px rgba(0,0, 0, .7)'}} />
              <div className="w-100 text-white">
                <h1 className="display-3">{props.loggedIn ? `Hello, ${props.name}. What shoes would you like today?` : 'Please log in'}</h1>
                <p className="lead mb-0"><Button className="btn-lg text-dark pinkButton" style={{backgroundColor: '#ffb1b9', border:'3px solid white', cursor: 'pointer', boxShadow: '0 10px 20px -8px rgba(0,0, 0, .7)'}} variant="primary">Let's Go Shopping!</Button></p>
              </div>
            </div>
          </div>
        </header>
